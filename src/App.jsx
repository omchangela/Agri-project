    ...
    <Router>
      <Routes>
        ...
        <Route path="/admin" element={<ProtectedRoute><AdminDashboard /></ProtectedRoute>}>
          ...
          <Route path="addproduct" element={<ProtectedRoute><AddMovies /></ProtectedRoute>} />
          <Route path="addcategory" element={<AddCategory />} />
          <Route path="addbrand" element={<ProtectedRoute><AddBanner /></ProtectedRoute>} />
          <Route path="listproduct" element={<ProtectedRoute><Listofmovie /></ProtectedRoute>} />
